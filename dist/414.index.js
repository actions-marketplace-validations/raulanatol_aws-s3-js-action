...
const util_endpoints_1 = __webpack_require__(2889);
const util_endpoints_2 = __webpack_require__(5473);
const ruleset_1 = __webpack_require__(3341);
...
var httpAuthSchemeProvider = __webpack_require__(9344);
var runtimeConfig = __webpack_require__(9756);
...
const tslib_1 = __webpack_require__(430);
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1092));
const core_1 = __webpack_require__(9963);
...
const runtimeConfig_shared_1 = __webpack_require__(4809);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9344);
const endpointResolver_1 = __webpack_require__(898);
const getRuntimeConfig = (config) => {
    return {
...
var utilEndpoints = __webpack_require__(5473);
var urlParser = __webpack_require__(4681);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4374); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(2666);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await Promise.all(/* import() */[__webpack_require__.e(178), __webpack_require__.e(334)]).then(__webpack_require__.t.bind(__webpack_require__, 7334, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(178), __webpack_require__.e(334)]).then(__webpack_require__.t.bind(__webpack_require__, 7334, 19));
