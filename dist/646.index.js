...
const shared_ini_file_loader_1 = __webpack_require__(3507);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(2273)));
...
var fromTokenFile = __webpack_require__(5614);
var fromWebToken = __webpack_require__(7905);
...
const util_endpoints_1 = __webpack_require__(5237);
...
const tslib_1 = __webpack_require__(1881);
